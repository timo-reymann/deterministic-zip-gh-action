# Contributing to deterministic-zip-gh-action
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT](https://github.com/timo-reymann/timo-reymann/deterministic-zip-gh-action/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
